...
Xtrain_path = "hf://datasets/NileshAtHuggingFace/visit-with-us-data-analysis/Xtrain.csv"
Xtest_path = "hf://datasets/NileshAtHuggingFace/visit-with-us-data-analysis/Xtest.csv"
ytrain_path = "hf://datasets/NileshAtHuggingFace/visit-with-us-data-analysis/ytrain.csv"
ytest_path = "hf://datasets/NileshAtHuggingFace/visit-with-us-data-analysis/ytest.csv"
...
categorical_features = [
    'TypeofContact', 'CityTier', 'Occupation', 'MaritalStatus',
...
with mlflow.start_run():
    ...
    model_path = "best_visit_with_us_model_v1.joblib"
    ...
    repo_id = "NileshAtHuggingFace/visit_with_us_model"
    repo_type = "model"
    ...
    api.upload_file(
        path_or_fileobj="best_visit_with_us_model_v1.joblib",
        path_in_repo="best_visit_with_us_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
